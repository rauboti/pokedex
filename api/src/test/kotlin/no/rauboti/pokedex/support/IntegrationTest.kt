package no.rauboti.pokedex.support
 ...
 *
 * Runs under the `test` profile (application-test.yml): Flyway applies the schema migrations
 * against the throwaway container, with no demo seed. Tests insert only the rows they need.
 */
@SpringBootTest
@ActiveProfiles("test")
