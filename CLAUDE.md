...
@rauboti/ui web, Postgres, hive OAuth (BFF), ports 3050/5050/5437. All stat math
...
and **record it** (`echo <branch> > .git/pokedex-active-increment`), then state the
current branch, the fresh branch created, and tree state. Enforced by
